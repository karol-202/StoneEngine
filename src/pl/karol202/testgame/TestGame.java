...
public class TestGame implements Game, Time.FPSListener
{
	...
	public void init()
	{
		...
		material.setEmissiveColor(new Vector3f(5f, 5f, 5f));
		material.setEmissiveTexture(Texture2D.loadTexture("./res/textures/scene_ems.png", true));
		...
		camera.addEffect(new PEBloom(10));
