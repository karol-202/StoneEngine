...
public class Texture2D implements Texture
{
	...
	public Texture2D(int width, int height, ByteBuffer buffer, boolean srgb)
	{
	...
	public static Texture2D loadTexture(String path, boolean srgb)
	{
		...
		try(FileInputStream fis = new FileInputStream(path))
		{
			...
			buffer.flip();
			return new Texture2D(decoder.getWidth(), decoder.getHeight(), buffer, srgb);
		}
		catch(IOException e)
		{
